    ...
    <div class="container" id="nav-container">
        <nav class="navbar navbar-expand-lg fixed-top">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-links">
                <a href="./adminPage.php" class="nav-item nav-link" id="home-menu">Home</a>
                <a href="./insert.php" class="nav-item nav-link" id="insert-menu">Inserir</a>
                <a href="./list.php" class="nav-item nav-link" id="edit-menu">Editar</a>
                <a href="../home/index.php" class="nav-item nav-link" id="exit-menu">Sair</a>
            </div>
        </nav>
    </div>
</header>